...
@java_type_count = local_unnamed_addr constant i32 329, align 4
...
@module4_managed_to_java = internal constant [237 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@module4_managed_to_java_duplicates = internal constant [122 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
...
@module11_managed_to_java = internal constant [30 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
		i32 33554473, ; type_token_id
...
@module11_managed_to_java_duplicates = internal constant [17 x %struct.TypeMapModuleEntry] [
	; 0
	%struct.TypeMapModuleEntry {
		i32 33554477, ; type_token_id
		i32 195; java_map_index
...
@__TypeMapModule_assembly_name.11 = internal constant [27 x i8] c"Xamarin.AndroidX.AppCompat\00", align 1
@__TypeMapModule_assembly_name.12 = internal constant [38 x i8] c"Xamarin.Google.Guava.ListenableFuture\00", align 1
@__TypeMapModule_assembly_name.13 = internal constant [37 x i8] c"Xamarin.AndroidX.Lifecycle.ViewModel\00", align 1
@__TypeMapModule_assembly_name.14 = internal constant [5 x i8] c"App1\00", align 1
...
@map_modules = global [15 x %struct.TypeMapModule] [
	...
	; 4
	%struct.TypeMapModule {
		[16 x i8] c"$H\E9\9C\89\A8\DCA\B9\E3z\D9\9A\88\C3D", ; module_uuid: 9ce94824-a889-41dc-b9e3-7ad99a88c344
		i32 237, ; entry_count
		i32 122, ; duplicate_count
		%struct.TypeMapModuleEntry* getelementptr inbounds ([237 x %struct.TypeMapModuleEntry], [237 x %struct.TypeMapModuleEntry]* @module4_managed_to_java, i32 0, i32 0), ; map
		%struct.TypeMapModuleEntry* getelementptr inbounds ([122 x %struct.TypeMapModuleEntry], [122 x %struct.TypeMapModuleEntry]* @module4_managed_to_java_duplicates, i32 0, i32 0), ; duplicate_map
	...
	; 6
	%struct.TypeMapModule {
		[16 x i8] c"]\BD\F3\C2\C7\BEWM\BDP#P\1C\85\950", ; module_uuid: c2f3bd5d-bec7-4d57-bd50-23501c859530
		i32 1, ; entry_count
	...
	%struct.TypeMapModule {
		...
		%struct.TypeMapModuleEntry* getelementptr inbounds ([30 x %struct.TypeMapModuleEntry], [30 x %struct.TypeMapModuleEntry]* @module11_managed_to_java, i32 0, i32 0), ; map
		%struct.TypeMapModuleEntry* getelementptr inbounds ([17 x %struct.TypeMapModuleEntry], [17 x %struct.TypeMapModuleEntry]* @module11_managed_to_java_duplicates, i32 0, i32 0), ; duplicate_map
		i8* getelementptr inbounds ([27 x i8], [27 x i8]* @__TypeMapModule_assembly_name.11, i32 0, i32 0), ; assembly_name: Xamarin.AndroidX.AppCompat
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}, 
	...
	%struct.TypeMapModule {
		...
		i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__TypeMapModule_assembly_name.12, i32 0, i32 0), ; assembly_name: Xamarin.Google.Guava.ListenableFuture
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}, 
	...
	; 14
	%struct.TypeMapModule {
		[16 x i8] c"\E8\B7\E9\1E^m\AC@\91\BEM\CA*G\8A\B9", ; module_uuid: 1ee9b7e8-6d5e-40ac-91be-4dca2a478ab9
		i32 1, ; entry_count
		i32 0, ; duplicate_count
		...
		%struct.TypeMapModuleEntry* null, ; duplicate_map
		i8* getelementptr inbounds ([5 x i8], [5 x i8]* @__TypeMapModule_assembly_name.14, i32 0, i32 0), ; assembly_name: App1
		%struct.MonoImage* null, ; image
		i32 0, ; java_name_width
		i8* null; java_map
	}
...
; map_java
@map_java = local_unnamed_addr constant [329 x %struct.TypeMapJava] [
	; 0
	%struct.TypeMapJava {
		i32 4, ; module_index
		i32 33554979, ; type_token_id
...
@map_java_hashes = local_unnamed_addr constant [329 x i64] [
	...
	i64 1853552035664219559, ; 31: 0x19b923c18277cda7 => android/animation/ValueAnimator
	i64 1869823426082872383, ; 32: 0x19f2f27fd05f9c3f => androidx/core/app/ActivityCompat$OnRequestPermissionsResultCallback
	i64 1877272793125324469, ; 33: 0x1a0d69a8bcbd86b5 => java/net/Proxy
	i64 1878806388185091404, ; 34: 0x1a12dc74a981cd4c => androidx/lifecycle/ViewModelStore
	i64 1920667697910321371, ; 35: 0x1aa79518598310db => androidx/loader/content/Loader
	i64 2071261092404328256, ; 36: 0x1cbe98fd51d8f740 => android/animation/Animator$AnimatorPauseListener
	i64 2091945087796016600, ; 37: 0x1d0814f947b475d8 => android/view/MenuInflater
	i64 2103360364221246790, ; 38: 0x1d30a31b700b2d46 => androidx/fragment/app/FragmentManager
	...
	i64 2542726837267699812, ; 48: 0x2349949628319864 => android/view/Window
	i64 2617258777567259524, ; 49: 0x24525efdca2b6b84 => androidx/fragment/app/FragmentManager$BackStackEntry
	i64 2972252214977986258, ; 50: 0x293f8fa450a17ed2 => android/content/Intent
	i64 2995689028570813766, ; 51: 0x2992d34cb57f9546 => android/animation/AnimatorSet
	...
	i64 4504302345287347834, ; 83: 0x3e827f1e43cfae7a => android/window/OnBackInvokedCallback
	i64 4590799101254748484, ; 84: 0x3fb5cb75a178c944 => javax/net/ssl/TrustManagerFactory
	i64 4657718675205956216, ; 85: 0x40a38a751b5aa278 => android/view/ActionMode$Callback
	i64 4668430364331232817, ; 86: 0x40c998ae949c4e31 => android/view/LayoutInflater$Factory
	...
	i64 5711826783282435557, ; 97: 0x4f447c32641c95e5 => androidx/drawerlayout/widget/DrawerLayout$DrawerListener
	i64 5793982059409158284, ; 98: 0x50685bfc3611b08c => java/net/URLConnection
	i64 5854524328054243249, ; 99: 0x513f72db968e3fb1 => java/security/cert/CertificateFactory
	...
	i64 6160296053631453721, ; 106: 0x557dc49f43f18a19 => android/graphics/PorterDuff
	i64 6190038067490173605, ; 107: 0x55e76ed37ee5b2a5 => androidx/core/app/ComponentActivity$ExtraData
	i64 6193589699106797389, ; 108: 0x55f40d042bc7774d => android/view/ActionMode
	i64 6204908697973250647, ; 109: 0x561c4395f66d5a57 => android/app/Application$ActivityLifecycleCallbacks
	i64 6296800472137223880, ; 110: 0x5762baaae3404ec8 => androidx/loader/content/Loader$OnLoadCompleteListener
	i64 6364569032989959824, ; 111: 0x58537dd087d16690 => android/view/KeyboardShortcutGroup
	i64 6373415978121019041, ; 112: 0x5872ec1075b3bea1 => mono/androidx/core/view/ActionProvider_VisibilityListenerImplementor
	i64 6485460119900587756, ; 113: 0x5a00fb9e1ba306ec => android/view/DragEvent
	i64 6577678479794931002, ; 114: 0x5b489bba32e8853a => androidx/appcompat/view/ActionMode$Callback
	i64 6686699664156607880, ; 115: 0x5ccbedeab9c74588 => androidx/fragment/app/FragmentFactory
	i64 6687740929511417890, ; 116: 0x5ccfa0f1355e6822 => mono/androidx/drawerlayout/widget/DrawerLayout_DrawerListenerImplementor
	i64 6740334783866200195, ; 117: 0x5d8a7ac62b8de083 => javax/net/ssl/SSLSession
	i64 6804602249961354267, ; 118: 0x5e6ecdb1aac5341b => android/view/Window$Callback
	i64 7017970021919054493, ; 119: 0x6164d68d58d35a9d => androidx/appcompat/app/AppCompatActivity
	i64 7282188369651690282, ; 120: 0x650f87bd5091eb2a => android/os/Parcelable
	i64 7291810569935423650, ; 121: 0x6531b714667088a2 => android/os/Build$VERSION
	...
	i64 7437796681088239247, ; 124: 0x67385cac9fd8068f => java/io/FileDescriptor
	i64 7538647566659605431, ; 125: 0x689ea805399bd3b7 => android/view/WindowManager$LayoutParams
	i64 7620119821450638162, ; 126: 0x69c01a9abf7a7352 => java/io/InterruptedIOException
	i64 7658195837123306865, ; 127: 0x6a476089fc1c2571 => java/lang/Character
	i64 7731510726439183081, ; 128: 0x6b4bd80ada87a2e9 => android/animation/ValueAnimator$AnimatorUpdateListener
	i64 7933543037734065265, ; 129: 0x6e199b5bee699471 => java/util/HashMap
	i64 8045985209002586618, ; 130: 0x6fa914eb0aa571fa => androidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener
	i64 8058145963905469793, ; 131: 0x6fd4490f6ed54d61 => android/view/ContextMenu$ContextMenuInfo
	i64 8188592205440608210, ; 132: 0x71a3b939cfd1e7d2 => androidx/appcompat/view/menu/MenuBuilder
	i64 8190305621607579207, ; 133: 0x71a9cf9199cdfe47 => java/nio/channels/spi/AbstractInterruptibleChannel
	i64 8209608963639478488, ; 134: 0x71ee63db269808d8 => java/util/function/Function
	i64 8416619862292774857, ; 135: 0x74cdd72bed753fc9 => java/lang/IllegalArgumentException
	i64 8487642170263250902, ; 136: 0x75ca29959b2aa7d6 => android/content/ContextWrapper
	i64 8549089476185573369, ; 137: 0x76a47795651247f9 => mono/androidx/core/view/ActionProvider_SubUiVisibilityListenerImplementor
	i64 8587172038193766563, ; 138: 0x772bc378d1b4e0a3 => java/lang/Runnable
	i64 8655205006257707444, ; 139: 0x781d7718902c59b4 => androidx/core/view/ActionProvider$SubUiVisibilityListener
	i64 8712284566595978930, ; 140: 0x78e840a7561246b2 => android/view/MenuItem$OnActionExpandListener
	i64 8717832878576044787, ; 141: 0x78fbf6d062bf0af3 => android/view/View$OnCreateContextMenuListener
	i64 8722435519081898203, ; 142: 0x790c50e4232060db => android/app/PendingIntent
	i64 8784751650103882924, ; 143: 0x79e9b5150877f4ac => android/content/res/Configuration
	i64 8785370249272798009, ; 144: 0x79ebe7b1e030ab39 => android/view/LayoutInflater$Factory2
	i64 8844400343224702393, ; 145: 0x7abd9f40a54055b9 => androidx/appcompat/view/menu/MenuItemImpl
	i64 8902410444401917848, ; 146: 0x7b8bb721d74dbf98 => crc64a7a6b04b89628087/MainActivity
	...
	i64 10722894652849872693, ; 183: 0x94cf5fdfdb0d5f35 => java/lang/Short
	i64 10783898034563810276, ; 184: 0x95a81a207c3583e4 => androidx/appcompat/app/ActionBarDrawerToggle$Delegate
	i64 10804287674762873921, ; 185: 0x95f08a65895f4c41 => androidx/fragment/app/Fragment$SavedState
	i64 10807464319380525259, ; 186: 0x95fbd389bf6290cb => android/window/OnBackInvokedDispatcher
	...
	i64 13805562342397192842, ; 251: 0xbf9735ce2f182a8a => android/util/AttributeSet
	i64 13814726415558267663, ; 252: 0xbfb7c47b3c8e530f => androidx/savedstate/SavedStateRegistry$SavedStateProvider
	i64 13864679446917576892, ; 253: 0xc0693c7fae2e78bc => java/util/function/ToDoubleFunction
	...
	i64 14006488896635186732, ; 256: 0xc2610b712264ae2c => java/lang/reflect/AnnotatedElement
	i64 14031640676547298208, ; 257: 0xc2ba66da3d8603a0 => java/nio/channels/FileChannel
	i64 14043684570532002328, ; 258: 0xc2e530b5d431ba18 => androidx/appcompat/app/ActionBar$Tab
	...
	i64 14166708697631601657, ; 261: 0xc49a428086c4b3f9 => androidx/savedstate/SavedStateRegistry
	i64 14167891754637755728, ; 262: 0xc49e767c735e8550 => java/lang/Object
	i64 14180814796703042768, ; 263: 0xc4cc5feca7168cd0 => java/lang/ClassCastException
	i64 14206023932851353817, ; 264: 0xc525ef800c4d78d9 => mono/android/runtime/OutputStreamAdapter
	i64 14257601591339809660, ; 265: 0xc5dd2d1b78da7b7c => java/nio/channels/InterruptibleChannel
	i64 14284032202517437988, ; 266: 0xc63b139baf4ade24 => androidx/fragment/app/FragmentActivity
	i64 14296237994325564878, ; 267: 0xc66670b60c37ddce => android/content/SharedPreferences
	i64 14328901088261815086, ; 268: 0xc6da7b9f3b8dbb2e => android/view/ViewParent
	i64 14361620789319229198, ; 269: 0xc74eba044a3cdf0e => android/os/Parcel
	i64 14409679416056247518, ; 270: 0xc7f97715494a74de => androidx/customview/widget/Openable
	i64 14428829850836958935, ; 271: 0xc83d804d57b07ed7 => java/util/Spliterator
	i64 14480243895569103343, ; 272: 0xc8f4291a786a39ef => androidx/core/app/ActivityCompat
	i64 14501341618205132561, ; 273: 0xc93f1d5ecfb48711 => java/lang/Byte
	i64 14517395435871339070, ; 274: 0xc978263b82fd023e => java/lang/Cloneable
	i64 14569564621816213537, ; 275: 0xca317dd4a7743021 => androidx/core/app/ActivityCompat$PermissionCompatDelegate
	i64 14684559126920293129, ; 276: 0xcbca08b94b4deb09 => java/lang/CharSequence
	i64 14940408132235664607, ; 277: 0xcf56fe09e1439cdf => java/lang/Throwable
	i64 14940704599466395126, ; 278: 0xcf580bac893d45f6 => android/util/Log
	...
	i64 15489276530192123430, ; 283: 0xd6f4f6f041e58626 => java/util/function/ToIntFunction
	i64 15633873768898914415, ; 284: 0xd8f6ad5c6a84686f => java/io/Writer
	i64 15645438581444444576, ; 285: 0xd91fc37f2a3001a0 => java/lang/Appendable
	i64 15655567004052913371, ; 286: 0xd943bf3e51e67cdb => androidx/lifecycle/LifecycleOwner
	i64 15696148966177826650, ; 287: 0xd9d3ec52aea4e75a => androidx/appcompat/widget/ScrollingTabContainerView
	i64 15699556301161391558, ; 288: 0xd9e00746adf865c6 => android/view/WindowMetrics
	i64 15767615218119146656, ; 289: 0xdad1d2801f08fca0 => javax/net/ssl/SSLSessionContext
	i64 15773716038598610423, ; 290: 0xdae77f2a148d4df7 => java/security/KeyStore$LoadStoreParameter
	i64 15822621356783831935, ; 291: 0xdb953e4aca9c0b7f => mono/android/animation/ValueAnimator_AnimatorUpdateListenerImplementor
	...
	i64 16314168557433322311, ; 295: 0xe26791dde7a8fb47 => android/view/ContextThemeWrapper
	i64 16395504991077438774, ; 296: 0xe38888ec1a509536 => java/nio/ByteBuffer
	i64 16480206070542885578, ; 297: 0xe4b5741af3f1e2ca => android/view/SearchEvent
	i64 16530905335535283041, ; 298: 0xe56992d17430ab61 => androidx/loader/app/LoaderManager$LoaderCallbacks
	i64 16542847110558016359, ; 299: 0xe593ffcc9e686367 => android/app/Application
	i64 16543572318389959461, ; 300: 0xe596935f399e7b25 => java/lang/reflect/TypeVariable
	i64 16603717322881265010, ; 301: 0xe66c40ef55566d72 => mono/android/runtime/JavaObject
	i64 16723123314454325679, ; 302: 0xe814780d351a69af => mono/android/runtime/InputStreamAdapter
	i64 16732048506261937943, ; 303: 0xe8342d775c591f17 => android/graphics/PorterDuff$Mode
	i64 16832017439803262409, ; 304: 0xe99756ae80a745c9 => android/view/ViewGroup
	i64 16878061737430998064, ; 305: 0xea3aebb9f4afdc30 => android/content/SharedPreferences$Editor
	i64 16916694887332905051, ; 306: 0xeac42c5f1d25005b => androidx/fragment/app/FragmentManager$FragmentLifecycleCallbacks
	i64 17053113564791162236, ; 307: 0xeca8d46f97c5c57c => androidx/lifecycle/Observer
	i64 17125416866214736517, ; 308: 0xeda9b3e7cd367285 => java/io/OutputStream
	i64 17163176023095185573, ; 309: 0xee2fd9a89a1710a5 => android/graphics/Matrix
	i64 17312589003384955623, ; 310: 0xf042abf8f91822e7 => android/view/KeyEvent
	i64 17405205501308712532, ; 311: 0xf18bb62fcc2e3654 => androidx/loader/content/Loader$OnLoadCanceledListener
	i64 17490083481060646178, ; 312: 0xf2b94242748c1d22 => java/util/Enumeration
	i64 17498018958444438720, ; 313: 0xf2d57388c321a4c0 => java/lang/Double
	i64 17499752140262191063, ; 314: 0xf2db9bda99b5afd7 => java/lang/ReflectiveOperationException
	i64 17519581955836770800, ; 315: 0xf3220ef752fe79f0 => java/security/KeyStore
	i64 17542023464739623563, ; 316: 0xf371c966495f528b => android/view/Display
	i64 17605619666541934257, ; 317: 0xf453b9cee2dcf6b1 => java/net/Proxy$Type
	i64 17608877981747935975, ; 318: 0xf45f4d3a83487ae7 => java/nio/Buffer
	i64 17645817129531856090, ; 319: 0xf4e28930113fd4da => java/io/Closeable
	i64 17671382671565006709, ; 320: 0xf53d5ce9aca02775 => androidx/fragment/app/FragmentTransaction
	i64 17672504001507146299, ; 321: 0xf54158c1a580ba3b => androidx/appcompat/graphics/drawable/DrawerArrowDrawable
	i64 17800186900405514025, ; 322: 0xf706f7ad2e3b6f29 => android/util/SparseArray
	i64 17956533498635850486, ; 323: 0xf9326c14479792f6 => androidx/core/view/KeyEventDispatcher$Component
	i64 18168729229555601518, ; 324: 0xfc244af8e3eb106e => androidx/core/internal/view/SupportMenu
	i64 18213852175163534091, ; 325: 0xfcc49a0d5c192b0b => android/content/SharedPreferences$OnSharedPreferenceChangeListener
	i64 18216578448169670053, ; 326: 0xfcce4995423095a5 => javax/net/ssl/SSLSocketFactory
	i64 18401512074820890716, ; 327: 0xff5f4dbc95c2b05c => java/lang/Float
	i64 18401692079723824300 ; 328: 0xff5ff1733e0ec4ac => java/util/Collection
], align 8
...
@__java_type_names.35 = internal constant [47 x i8] c"xamarin/android/net/OldAndroidSSLSocketFactory\00", align 1
@__java_type_names.36 = internal constant [32 x i8] c"javax/security/cert/Certificate\00", align 1
@__java_type_names.37 = internal constant [36 x i8] c"javax/security/cert/X509Certificate\00", align 1
@__java_type_names.38 = internal constant [28 x i8] c"javax/security/auth/Subject\00", align 1
@__java_type_names.39 = internal constant [24 x i8] c"javax/net/SocketFactory\00", align 1
@__java_type_names.40 = internal constant [33 x i8] c"javax/net/ssl/HttpsURLConnection\00", align 1
@__java_type_names.41 = internal constant [31 x i8] c"javax/net/ssl/HostnameVerifier\00", align 1
@__java_type_names.42 = internal constant [25 x i8] c"javax/net/ssl/KeyManager\00", align 1
@__java_type_names.43 = internal constant [25 x i8] c"javax/net/ssl/SSLSession\00", align 1
@__java_type_names.44 = internal constant [32 x i8] c"javax/net/ssl/SSLSessionContext\00", align 1
@__java_type_names.45 = internal constant [27 x i8] c"javax/net/ssl/TrustManager\00", align 1
@__java_type_names.46 = internal constant [31 x i8] c"javax/net/ssl/X509TrustManager\00", align 1
@__java_type_names.47 = internal constant [32 x i8] c"javax/net/ssl/KeyManagerFactory\00", align 1
@__java_type_names.48 = internal constant [25 x i8] c"javax/net/ssl/SSLContext\00", align 1
@__java_type_names.49 = internal constant [31 x i8] c"javax/net/ssl/SSLSocketFactory\00", align 1
@__java_type_names.50 = internal constant [34 x i8] c"javax/net/ssl/TrustManagerFactory\00", align 1
@__java_type_names.51 = internal constant [37 x i8] c"android/window/OnBackInvokedCallback\00", align 1
@__java_type_names.52 = internal constant [39 x i8] c"android/window/OnBackInvokedDispatcher\00", align 1
@__java_type_names.53 = internal constant [27 x i8] c"android/widget/AdapterView\00", align 1
@__java_type_names.54 = internal constant [50 x i8] c"android/widget/AdapterView$OnItemSelectedListener\00", align 1
@__java_type_names.55 = internal constant [27 x i8] c"android/widget/FrameLayout\00", align 1
@__java_type_names.56 = internal constant [36 x i8] c"android/widget/HorizontalScrollView\00", align 1
@__java_type_names.57 = internal constant [23 x i8] c"android/widget/Adapter\00", align 1
@__java_type_names.58 = internal constant [30 x i8] c"android/widget/SpinnerAdapter\00", align 1
@__java_type_names.59 = internal constant [24 x i8] c"android/view/ActionMode\00", align 1
@__java_type_names.60 = internal constant [33 x i8] c"android/view/ActionMode$Callback\00", align 1
@__java_type_names.61 = internal constant [28 x i8] c"android/view/ActionProvider\00", align 1
@__java_type_names.62 = internal constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 1
@__java_type_names.63 = internal constant [21 x i8] c"android/view/Display\00", align 1
@__java_type_names.64 = internal constant [23 x i8] c"android/view/DragEvent\00", align 1
@__java_type_names.65 = internal constant [41 x i8] c"android/view/ContextMenu$ContextMenuInfo\00", align 1
@__java_type_names.66 = internal constant [25 x i8] c"android/view/ContextMenu\00", align 1
@__java_type_names.67 = internal constant [18 x i8] c"android/view/Menu\00", align 1
@__java_type_names.68 = internal constant [45 x i8] c"android/view/MenuItem$OnActionExpandListener\00", align 1
@__java_type_names.69 = internal constant [46 x i8] c"android/view/MenuItem$OnMenuItemClickListener\00", align 1
@__java_type_names.70 = internal constant [22 x i8] c"android/view/MenuItem\00", align 1
@__java_type_names.71 = internal constant [24 x i8] c"android/view/InputEvent\00", align 1
@__java_type_names.72 = internal constant [21 x i8] c"android/view/SubMenu\00", align 1
@__java_type_names.73 = internal constant [25 x i8] c"android/view/ViewManager\00", align 1
@__java_type_names.74 = internal constant [24 x i8] c"android/view/ViewParent\00", align 1
@__java_type_names.75 = internal constant [40 x i8] c"android/view/WindowManager$LayoutParams\00", align 1
@__java_type_names.76 = internal constant [27 x i8] c"android/view/WindowManager\00", align 1
@__java_type_names.77 = internal constant [35 x i8] c"android/view/KeyboardShortcutGroup\00", align 1
@__java_type_names.78 = internal constant [22 x i8] c"android/view/KeyEvent\00", align 1
@__java_type_names.79 = internal constant [31 x i8] c"android/view/KeyEvent$Callback\00", align 1
@__java_type_names.80 = internal constant [28 x i8] c"android/view/LayoutInflater\00", align 1
@__java_type_names.81 = internal constant [36 x i8] c"android/view/LayoutInflater$Factory\00", align 1
@__java_type_names.82 = internal constant [37 x i8] c"android/view/LayoutInflater$Factory2\00", align 1
@__java_type_names.83 = internal constant [26 x i8] c"android/view/MenuInflater\00", align 1
@__java_type_names.84 = internal constant [25 x i8] c"android/view/MotionEvent\00", align 1
@__java_type_names.85 = internal constant [25 x i8] c"android/view/SearchEvent\00", align 1
@__java_type_names.86 = internal constant [18 x i8] c"android/view/View\00", align 1
@__java_type_names.87 = internal constant [34 x i8] c"android/view/View$OnClickListener\00", align 1
@__java_type_names.88 = internal constant [46 x i8] c"android/view/View$OnCreateContextMenuListener\00", align 1
@__java_type_names.89 = internal constant [23 x i8] c"android/view/ViewGroup\00", align 1
@__java_type_names.90 = internal constant [36 x i8] c"android/view/ViewGroup$LayoutParams\00", align 1
@__java_type_names.91 = internal constant [42 x i8] c"android/view/ViewGroup$MarginLayoutParams\00", align 1
@__java_type_names.92 = internal constant [34 x i8] c"android/view/ViewPropertyAnimator\00", align 1
@__java_type_names.93 = internal constant [20 x i8] c"android/view/Window\00", align 1
@__java_type_names.94 = internal constant [29 x i8] c"android/view/Window$Callback\00", align 1
@__java_type_names.95 = internal constant [27 x i8] c"android/view/WindowMetrics\00", align 1
@__java_type_names.96 = internal constant [33 x i8] c"android/view/animation/Animation\00", align 1
@__java_type_names.97 = internal constant [36 x i8] c"android/view/animation/Interpolator\00", align 1
@__java_type_names.98 = internal constant [46 x i8] c"android/view/accessibility/AccessibilityEvent\00", align 1
@__java_type_names.99 = internal constant [47 x i8] c"android/view/accessibility/AccessibilityRecord\00", align 1
@__java_type_names.100 = internal constant [52 x i8] c"android/view/accessibility/AccessibilityEventSource\00", align 1
@__java_type_names.101 = internal constant [28 x i8] c"android/util/DisplayMetrics\00", align 1
@__java_type_names.102 = internal constant [26 x i8] c"android/util/AttributeSet\00", align 1
@__java_type_names.103 = internal constant [17 x i8] c"android/util/Log\00", align 1
@__java_type_names.104 = internal constant [25 x i8] c"android/util/SparseArray\00", align 1
@__java_type_names.105 = internal constant [37 x i8] c"android/preference/PreferenceManager\00", align 1
@__java_type_names.106 = internal constant [22 x i8] c"android/os/BaseBundle\00", align 1
@__java_type_names.107 = internal constant [17 x i8] c"android/os/Build\00", align 1
@__java_type_names.108 = internal constant [25 x i8] c"android/os/Build$VERSION\00", align 1
@__java_type_names.109 = internal constant [18 x i8] c"android/os/Bundle\00", align 1
@__java_type_names.110 = internal constant [19 x i8] c"android/os/Handler\00", align 1
@__java_type_names.111 = internal constant [30 x i8] c"android/os/Parcelable$Creator\00", align 1
@__java_type_names.112 = internal constant [22 x i8] c"android/os/Parcelable\00", align 1
@__java_type_names.113 = internal constant [18 x i8] c"android/os/Looper\00", align 1
@__java_type_names.114 = internal constant [18 x i8] c"android/os/Parcel\00", align 1
@__java_type_names.115 = internal constant [16 x i8] c"android/net/Uri\00", align 1
@__java_type_names.116 = internal constant [27 x i8] c"android/graphics/BlendMode\00", align 1
@__java_type_names.117 = internal constant [24 x i8] c"android/graphics/Canvas\00", align 1
@__java_type_names.118 = internal constant [29 x i8] c"android/graphics/ColorFilter\00", align 1
@__java_type_names.119 = internal constant [24 x i8] c"android/graphics/Matrix\00", align 1
@__java_type_names.120 = internal constant [23 x i8] c"android/graphics/Paint\00", align 1
@__java_type_names.121 = internal constant [23 x i8] c"android/graphics/Point\00", align 1
@__java_type_names.122 = internal constant [28 x i8] c"android/graphics/PorterDuff\00", align 1
@__java_type_names.123 = internal constant [33 x i8] c"android/graphics/PorterDuff$Mode\00", align 1
@__java_type_names.124 = internal constant [22 x i8] c"android/graphics/Rect\00", align 1
@__java_type_names.125 = internal constant [23 x i8] c"android/graphics/RectF\00", align 1
@__java_type_names.126 = internal constant [35 x i8] c"android/graphics/drawable/Drawable\00", align 1
@__java_type_names.127 = internal constant [44 x i8] c"android/graphics/drawable/Drawable$Callback\00", align 1
@__java_type_names.128 = internal constant [33 x i8] c"android/database/DataSetObserver\00", align 1
@__java_type_names.129 = internal constant [27 x i8] c"android/animation/Animator\00", align 1
@__java_type_names.130 = internal constant [44 x i8] c"android/animation/Animator$AnimatorListener\00", align 1
@__java_type_names.131 = internal constant [49 x i8] c"android/animation/Animator$AnimatorPauseListener\00", align 1
@__java_type_names.132 = internal constant [42 x i8] c"android/animation/AnimatorListenerAdapter\00", align 1
@__java_type_names.133 = internal constant [30 x i8] c"android/animation/AnimatorSet\00", align 1
@__java_type_names.134 = internal constant [35 x i8] c"android/animation/TimeInterpolator\00", align 1
@__java_type_names.135 = internal constant [32 x i8] c"android/animation/ValueAnimator\00", align 1
@__java_type_names.136 = internal constant [55 x i8] c"android/animation/ValueAnimator$AnimatorUpdateListener\00", align 1
@__java_type_names.137 = internal constant [71 x i8] c"mono/android/animation/ValueAnimator_AnimatorUpdateListenerImplementor\00", align 1
@__java_type_names.138 = internal constant [21 x i8] c"android/app/Activity\00", align 1
@__java_type_names.139 = internal constant [24 x i8] c"android/app/Application\00", align 1
@__java_type_names.140 = internal constant [51 x i8] c"android/app/Application$ActivityLifecycleCallbacks\00", align 1
@__java_type_names.141 = internal constant [19 x i8] c"android/app/Dialog\00", align 1
@__java_type_names.142 = internal constant [26 x i8] c"android/app/PendingIntent\00", align 1
@__java_type_names.143 = internal constant [30 x i8] c"android/content/ComponentName\00", align 1
@__java_type_names.144 = internal constant [24 x i8] c"android/content/Context\00", align 1
@__java_type_names.145 = internal constant [31 x i8] c"android/content/ContextWrapper\00", align 1
@__java_type_names.146 = internal constant [35 x i8] c"android/content/ComponentCallbacks\00", align 1
@__java_type_names.147 = internal constant [36 x i8] c"android/content/ComponentCallbacks2\00", align 1
@__java_type_names.148 = internal constant [32 x i8] c"android/content/DialogInterface\00", align 1
@__java_type_names.149 = internal constant [23 x i8] c"android/content/Intent\00", align 1
@__java_type_names.150 = internal constant [29 x i8] c"android/content/IntentSender\00", align 1
@__java_type_names.151 = internal constant [41 x i8] c"android/content/SharedPreferences$Editor\00", align 1
@__java_type_names.152 = internal constant [67 x i8] c"android/content/SharedPreferences$OnSharedPreferenceChangeListener\00", align 1
@__java_type_names.153 = internal constant [34 x i8] c"android/content/SharedPreferences\00", align 1
@__java_type_names.154 = internal constant [35 x i8] c"android/content/res/ColorStateList\00", align 1
@__java_type_names.155 = internal constant [34 x i8] c"android/content/res/Configuration\00", align 1
@__java_type_names.156 = internal constant [30 x i8] c"android/content/res/Resources\00", align 1
@__java_type_names.157 = internal constant [31 x i8] c"android/content/pm/PackageInfo\00", align 1
@__java_type_names.158 = internal constant [34 x i8] c"android/content/pm/PackageManager\00", align 1
@__java_type_names.159 = internal constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 1
@__java_type_names.160 = internal constant [31 x i8] c"mono/android/runtime/JavaArray\00", align 1
@__java_type_names.161 = internal constant [21 x i8] c"java/util/Collection\00", align 1
@__java_type_names.162 = internal constant [18 x i8] c"java/util/HashMap\00", align 1
@__java_type_names.163 = internal constant [20 x i8] c"java/util/ArrayList\00", align 1
@__java_type_names.164 = internal constant [32 x i8] c"mono/android/runtime/JavaObject\00", align 1
@__java_type_names.165 = internal constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 1
@__java_type_names.166 = internal constant [18 x i8] c"java/util/HashSet\00", align 1
@__java_type_names.167 = internal constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 1
@__java_type_names.168 = internal constant [21 x i8] c"java/util/Comparator\00", align 1
@__java_type_names.169 = internal constant [22 x i8] c"java/util/Enumeration\00", align 1
@__java_type_names.170 = internal constant [19 x i8] c"java/util/Iterator\00", align 1
@__java_type_names.171 = internal constant [22 x i8] c"java/util/Spliterator\00", align 1
@__java_type_names.172 = internal constant [17 x i8] c"java/util/Random\00", align 1
@__java_type_names.173 = internal constant [28 x i8] c"java/util/function/Consumer\00", align 1
@__java_type_names.174 = internal constant [28 x i8] c"java/util/function/Function\00", align 1
@__java_type_names.175 = internal constant [36 x i8] c"java/util/function/ToDoubleFunction\00", align 1
@__java_type_names.176 = internal constant [33 x i8] c"java/util/function/ToIntFunction\00", align 1
@__java_type_names.177 = internal constant [34 x i8] c"java/util/function/ToLongFunction\00", align 1
@__java_type_names.178 = internal constant [30 x i8] c"java/util/concurrent/Executor\00", align 1
@__java_type_names.179 = internal constant [28 x i8] c"java/util/concurrent/Future\00", align 1
@__java_type_names.180 = internal constant [30 x i8] c"java/util/concurrent/TimeUnit\00", align 1
@__java_type_names.181 = internal constant [24 x i8] c"java/security/Principal\00", align 1
@__java_type_names.182 = internal constant [23 x i8] c"java/security/KeyStore\00", align 1
@__java_type_names.183 = internal constant [42 x i8] c"java/security/KeyStore$LoadStoreParameter\00", align 1
@__java_type_names.184 = internal constant [43 x i8] c"java/security/KeyStore$ProtectionParameter\00", align 1
@__java_type_names.185 = internal constant [27 x i8] c"java/security/SecureRandom\00", align 1
@__java_type_names.186 = internal constant [31 x i8] c"java/security/cert/Certificate\00", align 1
@__java_type_names.187 = internal constant [38 x i8] c"java/security/cert/CertificateFactory\00", align 1
@__java_type_names.188 = internal constant [33 x i8] c"java/security/cert/X509Extension\00", align 1
@__java_type_names.189 = internal constant [35 x i8] c"java/security/cert/X509Certificate\00", align 1
@__java_type_names.190 = internal constant [16 x i8] c"java/nio/Buffer\00", align 1
@__java_type_names.191 = internal constant [20 x i8] c"java/nio/ByteBuffer\00", align 1
@__java_type_names.192 = internal constant [30 x i8] c"java/nio/channels/FileChannel\00", align 1
@__java_type_names.193 = internal constant [30 x i8] c"java/nio/channels/ByteChannel\00", align 1
@__java_type_names.194 = internal constant [26 x i8] c"java/nio/channels/Channel\00", align 1
@__java_type_names.195 = internal constant [39 x i8] c"java/nio/channels/GatheringByteChannel\00", align 1
@__java_type_names.196 = internal constant [39 x i8] c"java/nio/channels/InterruptibleChannel\00", align 1
@__java_type_names.197 = internal constant [38 x i8] c"java/nio/channels/ReadableByteChannel\00", align 1
@__java_type_names.198 = internal constant [40 x i8] c"java/nio/channels/ScatteringByteChannel\00", align 1
@__java_type_names.199 = internal constant [38 x i8] c"java/nio/channels/SeekableByteChannel\00", align 1
@__java_type_names.200 = internal constant [38 x i8] c"java/nio/channels/WritableByteChannel\00", align 1
@__java_type_names.201 = internal constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 1
@__java_type_names.202 = internal constant [26 x i8] c"java/net/ConnectException\00", align 1
@__java_type_names.203 = internal constant [27 x i8] c"java/net/HttpURLConnection\00", align 1
@__java_type_names.204 = internal constant [27 x i8] c"java/net/InetSocketAddress\00", align 1
@__java_type_names.205 = internal constant [27 x i8] c"java/net/ProtocolException\00", align 1
@__java_type_names.206 = internal constant [15 x i8] c"java/net/Proxy\00", align 1
@__java_type_names.207 = internal constant [20 x i8] c"java/net/Proxy$Type\00", align 1
@__java_type_names.208 = internal constant [23 x i8] c"java/net/ProxySelector\00", align 1
@__java_type_names.209 = internal constant [23 x i8] c"java/net/SocketAddress\00", align 1
@__java_type_names.210 = internal constant [25 x i8] c"java/net/SocketException\00", align 1
@__java_type_names.211 = internal constant [32 x i8] c"java/net/SocketTimeoutException\00", align 1
@__java_type_names.212 = internal constant [33 x i8] c"java/net/UnknownServiceException\00", align 1
@__java_type_names.213 = internal constant [13 x i8] c"java/net/URI\00", align 1
@__java_type_names.214 = internal constant [13 x i8] c"java/net/URL\00", align 1
@__java_type_names.215 = internal constant [23 x i8] c"java/net/URLConnection\00", align 1
@__java_type_names.216 = internal constant [18 x i8] c"java/lang/Boolean\00", align 1
@__java_type_names.217 = internal constant [15 x i8] c"java/lang/Byte\00", align 1
@__java_type_names.218 = internal constant [20 x i8] c"java/lang/Character\00", align 1
@__java_type_names.219 = internal constant [16 x i8] c"java/lang/Class\00", align 1
@__java_type_names.220 = internal constant [29 x i8] c"java/lang/ClassCastException\00", align 1
@__java_type_names.221 = internal constant [22 x i8] c"java/lang/ClassLoader\00", align 1
@__java_type_names.222 = internal constant [33 x i8] c"java/lang/ClassNotFoundException\00", align 1
@__java_type_names.223 = internal constant [17 x i8] c"java/lang/Double\00", align 1
@__java_type_names.224 = internal constant [15 x i8] c"java/lang/Enum\00", align 1
@__java_type_names.225 = internal constant [16 x i8] c"java/lang/Error\00", align 1
@__java_type_names.226 = internal constant [20 x i8] c"java/lang/Exception\00", align 1
@__java_type_names.227 = internal constant [16 x i8] c"java/lang/Float\00", align 1
@__java_type_names.228 = internal constant [21 x i8] c"java/lang/Appendable\00", align 1
@__java_type_names.229 = internal constant [23 x i8] c"java/lang/CharSequence\00", align 1
@__java_type_names.230 = internal constant [20 x i8] c"java/lang/Cloneable\00", align 1
@__java_type_names.231 = internal constant [21 x i8] c"java/lang/Comparable\00", align 1
@__java_type_names.232 = internal constant [19 x i8] c"java/lang/Iterable\00", align 1
@__java_type_names.233 = internal constant [35 x i8] c"java/lang/IllegalArgumentException\00", align 1
@__java_type_names.234 = internal constant [32 x i8] c"java/lang/IllegalStateException\00", align 1
@__java_type_names.235 = internal constant [36 x i8] c"java/lang/IndexOutOfBoundsException\00", align 1
@__java_type_names.236 = internal constant [18 x i8] c"java/lang/Integer\00", align 1
@__java_type_names.237 = internal constant [19 x i8] c"java/lang/Runnable\00", align 1
@__java_type_names.238 = internal constant [23 x i8] c"java/lang/LinkageError\00", align 1
@__java_type_names.239 = internal constant [15 x i8] c"java/lang/Long\00", align 1
@__java_type_names.240 = internal constant [31 x i8] c"java/lang/NoClassDefFoundError\00", align 1
@__java_type_names.241 = internal constant [31 x i8] c"java/lang/NullPointerException\00", align 1
@__java_type_names.242 = internal constant [17 x i8] c"java/lang/Number\00", align 1
@__java_type_names.243 = internal constant [17 x i8] c"java/lang/Object\00", align 1
@__java_type_names.244 = internal constant [39 x i8] c"java/lang/ReflectiveOperationException\00", align 1
@__java_type_names.245 = internal constant [27 x i8] c"java/lang/RuntimeException\00", align 1
@__java_type_names.246 = internal constant [28 x i8] c"java/lang/SecurityException\00", align 1
...
@__java_type_names.252 = internal constant [40 x i8] c"java/lang/UnsupportedOperationException\00", align 1
@__java_type_names.253 = internal constant [35 x i8] c"java/lang/reflect/AnnotatedElement\00", align 1
@__java_type_names.254 = internal constant [37 x i8] c"java/lang/reflect/GenericDeclaration\00", align 1
@__java_type_names.255 = internal constant [23 x i8] c"java/lang/reflect/Type\00", align 1
@__java_type_names.256 = internal constant [31 x i8] c"java/lang/reflect/TypeVariable\00", align 1
@__java_type_names.257 = internal constant [32 x i8] c"java/lang/annotation/Annotation\00", align 1
@__java_type_names.258 = internal constant [13 x i8] c"java/io/File\00", align 1
@__java_type_names.259 = internal constant [23 x i8] c"java/io/FileDescriptor\00", align 1
@__java_type_names.260 = internal constant [24 x i8] c"java/io/FileInputStream\00", align 1
@__java_type_names.261 = internal constant [18 x i8] c"java/io/Closeable\00", align 1
@__java_type_names.262 = internal constant [18 x i8] c"java/io/Flushable\00", align 1
@__java_type_names.263 = internal constant [20 x i8] c"java/io/InputStream\00", align 1
@__java_type_names.264 = internal constant [31 x i8] c"java/io/InterruptedIOException\00", align 1
@__java_type_names.265 = internal constant [20 x i8] c"java/io/IOException\00", align 1
@__java_type_names.266 = internal constant [21 x i8] c"java/io/Serializable\00", align 1
@__java_type_names.267 = internal constant [21 x i8] c"java/io/OutputStream\00", align 1
@__java_type_names.268 = internal constant [20 x i8] c"java/io/PrintWriter\00", align 1
@__java_type_names.269 = internal constant [21 x i8] c"java/io/StringWriter\00", align 1
@__java_type_names.270 = internal constant [15 x i8] c"java/io/Writer\00", align 1
@__java_type_names.271 = internal constant [25 x i8] c"mono/android/TypeManager\00", align 1
@__java_type_names.272 = internal constant [39 x i8] c"androidx/fragment/app/FragmentActivity\00", align 1
@__java_type_names.273 = internal constant [31 x i8] c"androidx/fragment/app/Fragment\00", align 1
@__java_type_names.274 = internal constant [42 x i8] c"androidx/fragment/app/Fragment$SavedState\00", align 1
@__java_type_names.275 = internal constant [38 x i8] c"androidx/fragment/app/FragmentFactory\00", align 1
@__java_type_names.276 = internal constant [38 x i8] c"androidx/fragment/app/FragmentManager\00", align 1
@__java_type_names.277 = internal constant [53 x i8] c"androidx/fragment/app/FragmentManager$BackStackEntry\00", align 1
@__java_type_names.278 = internal constant [65 x i8] c"androidx/fragment/app/FragmentManager$FragmentLifecycleCallbacks\00", align 1
@__java_type_names.279 = internal constant [65 x i8] c"androidx/fragment/app/FragmentManager$OnBackStackChangedListener\00", align 1
@__java_type_names.280 = internal constant [81 x i8] c"mono/androidx/fragment/app/FragmentManager_OnBackStackChangedListenerImplementor\00", align 1
@__java_type_names.281 = internal constant [42 x i8] c"androidx/fragment/app/FragmentTransaction\00", align 1
@__java_type_names.282 = internal constant [55 x i8] c"crc64a0e0a82d0db9a07d/ActivityLifecycleContextListener\00", align 1
@__java_type_names.283 = internal constant [31 x i8] c"androidx/loader/content/Loader\00", align 1
@__java_type_names.284 = internal constant [54 x i8] c"androidx/loader/content/Loader$OnLoadCanceledListener\00", align 1
@__java_type_names.285 = internal constant [54 x i8] c"androidx/loader/content/Loader$OnLoadCompleteListener\00", align 1
@__java_type_names.286 = internal constant [34 x i8] c"androidx/loader/app/LoaderManager\00", align 1
@__java_type_names.287 = internal constant [50 x i8] c"androidx/loader/app/LoaderManager$LoaderCallbacks\00", align 1
@__java_type_names.288 = internal constant [36 x i8] c"androidx/activity/ComponentActivity\00", align 1
@__java_type_names.289 = internal constant [28 x i8] c"androidx/lifecycle/Observer\00", align 1
@__java_type_names.290 = internal constant [28 x i8] c"androidx/lifecycle/LiveData\00", align 1
@__java_type_names.291 = internal constant [36 x i8] c"androidx/customview/widget/Openable\00", align 1
@__java_type_names.292 = internal constant [57 x i8] c"androidx/appcompat/graphics/drawable/DrawerArrowDrawable\00", align 1
@__java_type_names.293 = internal constant [33 x i8] c"androidx/appcompat/app/ActionBar\00", align 1
@__java_type_names.294 = internal constant [46 x i8] c"androidx/appcompat/app/ActionBar$LayoutParams\00", align 1
@__java_type_names.295 = internal constant [58 x i8] c"androidx/appcompat/app/ActionBar$OnMenuVisibilityListener\00", align 1
@__java_type_names.296 = internal constant [74 x i8] c"mono/androidx/appcompat/app/ActionBar_OnMenuVisibilityListenerImplementor\00", align 1
@__java_type_names.297 = internal constant [54 x i8] c"androidx/appcompat/app/ActionBar$OnNavigationListener\00", align 1
@__java_type_names.298 = internal constant [37 x i8] c"androidx/appcompat/app/ActionBar$Tab\00", align 1
@__java_type_names.299 = internal constant [45 x i8] c"androidx/appcompat/app/ActionBar$TabListener\00", align 1
@__java_type_names.300 = internal constant [45 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle\00", align 1
@__java_type_names.301 = internal constant [54 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle$Delegate\00", align 1
@__java_type_names.302 = internal constant [62 x i8] c"androidx/appcompat/app/ActionBarDrawerToggle$DelegateProvider\00", align 1
@__java_type_names.303 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatActivity\00", align 1
@__java_type_names.304 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatDelegate\00", align 1
@__java_type_names.305 = internal constant [41 x i8] c"androidx/appcompat/app/AppCompatCallback\00", align 1
@__java_type_names.306 = internal constant [34 x i8] c"androidx/appcompat/widget/Toolbar\00", align 1
@__java_type_names.307 = internal constant [67 x i8] c"androidx/appcompat/widget/Toolbar_NavigationOnClickEventDispatcher\00", align 1
@__java_type_names.308 = internal constant [58 x i8] c"androidx/appcompat/widget/Toolbar$OnMenuItemClickListener\00", align 1
@__java_type_names.309 = internal constant [74 x i8] c"mono/androidx/appcompat/widget/Toolbar_OnMenuItemClickListenerImplementor\00", align 1
@__java_type_names.310 = internal constant [39 x i8] c"androidx/appcompat/widget/DecorToolbar\00", align 1
@__java_type_names.311 = internal constant [52 x i8] c"androidx/appcompat/widget/ScrollingTabContainerView\00", align 1
@__java_type_names.312 = internal constant [75 x i8] c"androidx/appcompat/widget/ScrollingTabContainerView$VisibilityAnimListener\00", align 1
@__java_type_names.313 = internal constant [35 x i8] c"androidx/appcompat/view/ActionMode\00", align 1
@__java_type_names.314 = internal constant [44 x i8] c"androidx/appcompat/view/ActionMode$Callback\00", align 1
@__java_type_names.315 = internal constant [41 x i8] c"androidx/appcompat/view/menu/MenuBuilder\00", align 1
@__java_type_names.316 = internal constant [50 x i8] c"androidx/appcompat/view/menu/MenuBuilder$Callback\00", align 1
@__java_type_names.317 = internal constant [52 x i8] c"androidx/appcompat/view/menu/MenuPresenter$Callback\00", align 1
@__java_type_names.318 = internal constant [43 x i8] c"androidx/appcompat/view/menu/MenuPresenter\00", align 1
...
@__java_type_names.322 = internal constant [51 x i8] c"com/google/common/util/concurrent/ListenableFuture\00", align 1
@__java_type_names.323 = internal constant [54 x i8] c"androidx/lifecycle/HasDefaultViewModelProviderFactory\00", align 1
@__java_type_names.324 = internal constant [39 x i8] c"androidx/lifecycle/ViewModelStoreOwner\00", align 1
@__java_type_names.325 = internal constant [37 x i8] c"androidx/lifecycle/ViewModelProvider\00", align 1
@__java_type_names.326 = internal constant [45 x i8] c"androidx/lifecycle/ViewModelProvider$Factory\00", align 1
@__java_type_names.327 = internal constant [34 x i8] c"androidx/lifecycle/ViewModelStore\00", align 1
@__java_type_names.328 = internal constant [35 x i8] c"crc64a7a6b04b89628087/MainActivity\00", align 1

@java_type_names = local_unnamed_addr constant [329 x i8*] [
	...
	i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__java_type_names.38, i32 0, i32 0),
	i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__java_type_names.39, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__java_type_names.42, i32 0, i32 0),
	i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__java_type_names.43, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__java_type_names.57, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__java_type_names.63, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.70, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__java_type_names.90, i32 0, i32 0),
	i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__java_type_names.91, i32 0, i32 0),
	i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__java_type_names.92, i32 0, i32 0),
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.93, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.110, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__java_type_names.113, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__java_type_names.121, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.124, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([44 x i8], [44 x i8]* @__java_type_names.127, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__java_type_names.136, i32 0, i32 0),
	i8* getelementptr inbounds ([71 x i8], [71 x i8]* @__java_type_names.137, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([51 x i8], [51 x i8]* @__java_type_names.140, i32 0, i32 0),
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.141, i32 0, i32 0),
	i8* getelementptr inbounds ([26 x i8], [26 x i8]* @__java_type_names.142, i32 0, i32 0),
	i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__java_type_names.143, i32 0, i32 0),
	i8* getelementptr inbounds ([24 x i8], [24 x i8]* @__java_type_names.144, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__java_type_names.148, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__java_type_names.152, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.169, i32 0, i32 0),
	i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__java_type_names.170, i32 0, i32 0),
	i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__java_type_names.171, i32 0, i32 0),
	i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__java_type_names.172, i32 0, i32 0),
	i8* getelementptr inbounds ([28 x i8], [28 x i8]* @__java_type_names.173, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([33 x i8], [33 x i8]* @__java_type_names.176, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.190, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([39 x i8], [39 x i8]* @__java_type_names.196, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__java_type_names.199, i32 0, i32 0),
	i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__java_type_names.200, i32 0, i32 0),
	i8* getelementptr inbounds ([51 x i8], [51 x i8]* @__java_type_names.201, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.206, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__java_type_names.213, i32 0, i32 0),
	i8* getelementptr inbounds ([13 x i8], [13 x i8]* @__java_type_names.214, i32 0, i32 0),
	i8* getelementptr inbounds ([23 x i8], [23 x i8]* @__java_type_names.215, i32 0, i32 0),
	i8* getelementptr inbounds ([18 x i8], [18 x i8]* @__java_type_names.216, i32 0, i32 0),
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.217, i32 0, i32 0),
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.218, i32 0, i32 0),
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.219, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([17 x i8], [17 x i8]* @__java_type_names.223, i32 0, i32 0),
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.224, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([16 x i8], [16 x i8]* @__java_type_names.227, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__java_type_names.263, i32 0, i32 0),
	i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__java_type_names.264, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([21 x i8], [21 x i8]* @__java_type_names.269, i32 0, i32 0),
	i8* getelementptr inbounds ([15 x i8], [15 x i8]* @__java_type_names.270, i32 0, i32 0),
	i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__java_type_names.271, i32 0, i32 0),
	i8* getelementptr inbounds ([39 x i8], [39 x i8]* @__java_type_names.272, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__java_type_names.275, i32 0, i32 0),
	i8* getelementptr inbounds ([38 x i8], [38 x i8]* @__java_type_names.276, i32 0, i32 0),
	i8* getelementptr inbounds ([53 x i8], [53 x i8]* @__java_type_names.277, i32 0, i32 0),
	i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__java_type_names.278, i32 0, i32 0),
	i8* getelementptr inbounds ([65 x i8], [65 x i8]* @__java_type_names.279, i32 0, i32 0),
	i8* getelementptr inbounds ([81 x i8], [81 x i8]* @__java_type_names.280, i32 0, i32 0),
	i8* getelementptr inbounds ([42 x i8], [42 x i8]* @__java_type_names.281, i32 0, i32 0),
	i8* getelementptr inbounds ([55 x i8], [55 x i8]* @__java_type_names.282, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([58 x i8], [58 x i8]* @__java_type_names.295, i32 0, i32 0),
	i8* getelementptr inbounds ([74 x i8], [74 x i8]* @__java_type_names.296, i32 0, i32 0),
	i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__java_type_names.297, i32 0, i32 0),
	i8* getelementptr inbounds ([37 x i8], [37 x i8]* @__java_type_names.298, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([62 x i8], [62 x i8]* @__java_type_names.302, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([67 x i8], [67 x i8]* @__java_type_names.307, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([39 x i8], [39 x i8]* @__java_type_names.310, i32 0, i32 0),
	i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__java_type_names.311, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([52 x i8], [52 x i8]* @__java_type_names.317, i32 0, i32 0),
	...
	i8* getelementptr inbounds ([51 x i8], [51 x i8]* @__java_type_names.322, i32 0, i32 0),
	i8* getelementptr inbounds ([54 x i8], [54 x i8]* @__java_type_names.323, i32 0, i32 0),
